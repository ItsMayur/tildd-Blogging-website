      ...
      <div className="space-y-2">
        ...
        <div>
          <ul className="flex space-x-2">
            <li className="w-8 h-8 justify-center items-center flex">
              <Link href="https://www.linkedin.com/in/itsmayur718/">
                <svg
            ...
            <li className="w-8 h-8 justify-center items-center flex">
              <Link href="https://www.instagram.com/hnji_mayur/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-7 w-7"
                  fill="currentColor"
            ...
            <li className="w-8 h-8 justify-center items-center flex">
              <Link href="https://twitter.com/ItsMayur718">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-7 w-7"
                  fill="currentColor"
